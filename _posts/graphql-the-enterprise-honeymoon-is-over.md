...
excerpt: "GraphQL solves a real problem, but in many enterprise setups that problem is already handled by BFFs. After years using Apollo in production, I think the tradeoffs often outweigh the win."
coverImage: "/assets/blog/graphql-the-enterprise-honeymoon-is-over/cover.avif"
date: "2025-12-14 16:49"
ogImage:
  url: "/assets/blog/graphql-the-enterprise-honeymoon-is-over/cover.avif"
---
